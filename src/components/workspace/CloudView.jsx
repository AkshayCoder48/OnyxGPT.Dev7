...
import { Database, HardDrive, Network, Cpu, Plus, RefreshCw, Trash2, X, Check } from 'lucide-react';
...
export default function CloudView() {
  ...
  return (
    <div className="h-full flex bg-background text-gray-100 font-sans">
      {/* Sub-Sidebar */}
      <div className="w-56 border-r border-gray-800 bg-surface/50 p-4 flex flex-col space-y-2 shrink-0">
        <h3 className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-4 px-2">Services</h3>
